...
Number *Integer::add(Number * num) {
	...
	other->set_val(other->val()+double(value));
	delete(this);
	return other;
    } else if (num->types() == COMPLEX) {
	Complex * other = dynamic_cast<Complex*>(num);
	other->set_val(other->real()+double(value),other->imag());
	delete(this);
	return other;
    } else {
	return nullptr;
...
Number *Integer::sub(Number * num) {
	...
	Float * other = dynamic_cast<Float*>(num);
	other->set_val(double(value)-other->val());
	delete(this);
	return other;
    } else if (num->types() == COMPLEX) {
	Complex * other = dynamic_cast<Complex*>(num);
	other->set_val(double(value)-other->real(),-other->imag());
	delete(this);
	return other;
    } else {
	return nullptr;
...
Number *Integer::mul(Number * num) {
	...
	Complex * other = dynamic_cast<Complex*>(num);
	other->set_val(other->real()*double(value),other->imag()*double(value));
	delete(this);
	return other;
    } else {
	return nullptr;
